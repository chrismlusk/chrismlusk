...
import { theme, ContentStyles } from '../components/styles';

const LeadGraph = styled.p`
  margin-bottom: 1rem;
  padding-bottom: 1rem;
  font-size: 1.25em;
  border-bottom: 5px solid ${props => props.theme.color.gray200};
`;

const HireMe = props => (
  <ContentStyles>
    <h1>Hi! I'm <span style={{ color: `${theme.primary}` }}>Chris Lusk</span></h1>
